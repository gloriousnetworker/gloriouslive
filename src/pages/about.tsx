          ...
          <div className="flex flex-col md:flex-row items-center justify-center space-y-8 md:space-y-0 md:space-x-12">
            ...
            <div className="max-w-lg text-center md:text-left">
              ...
              <Link href="/skills" legacyBehavior>
                <a className="inline-block mt-8 bg-blue-600 text-white py-3 px-6 rounded-lg hover:bg-blue-700 transition duration-300">
                  See My Skills
                </a>
              </Link>
            </div>
...
<section id="experience" className="py-16 bg-gray-200"> {/* Updated background color */}
  <div className="container mx-auto px-4">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
      ...
      <div className="p-6 bg-gray-100 shadow-md rounded-lg hover:bg-gray-300 transition duration-300">
        <h3 className="text-2xl font-semibold text-gray-800">Frontend Developer - HNG Internship</h3>
        <p className="mt-4 text-gray-600">
          Completed the HNG Internship program, gaining hands-on experience in fullstack development and working on team-based projects.
        </p>
        <p className="mt-2 text-gray-600">
          <strong>Technologies:</strong> JavaScript, React, Node.js, Next.js, Tailwind CSS.
        </p>
      </div>
    </div>
  </div>
